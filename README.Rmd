...
triangulated subsets of maps, subject to error tolerances.  The vertices in the
reduced mesh are also vertices in the original, and they are arranged to form
